const Footer = () => {
  return (
    <footer className="w-full opacity-100 bg-gradient-to-r from-[#C9729A] to-[#923ADB] p-4 text-[#1A1A1A] font-bold mt-44 md:p-12 lg:m-0 lg:p-24">
